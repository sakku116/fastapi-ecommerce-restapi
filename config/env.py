...
class Env:
    ...
    INITIAL_CUSTOMER_USER_USERNAME: str = os.getenv(
        "INITIAL_CUSTOMER_USER_USERNAME", ""
    )
    INITIAL_CUSTOMER_USER_PASSWORD: str = os.getenv(
    ...
    GOOGLE_OAUTH2_WEB_CLIENT_ID: str = os.getenv("GOOGLE_OAUTH2_WEB_CLIENT_ID", "")
    GOOGLE_OAUTH2_WEB_CLIENT_SECRET: str = os.getenv(
        "GOOGLE_OAUTH2_WEB_CLIENT_SECRET", ""
    )
    GOOGLE_OAUTH2_MOBILE_CLIENT_ID: str = os.getenv(
        "GOOGLE_OAUTH2_MOBILE_CLIENT_ID", ""
    )
    GOOGLE_OAUTH2_MOBILE_CLIENT_SECRET: str = os.getenv(
        "GOOGLE_OAUTH2_MOBILE_CLIENT_SECRET", ""
    )
